...
measurement_summary_explaination <- data.frame(Variables = c("Measurement Date", "Station code", "Address", "Latitude", "Longitude", "SO2", "NO2", "O3", "CO", "PM10", "PM2.5"), 
                                               Explaination = c("Date of Measurement", "Station code", "Address of monitoring station", "Latitude of station", "Longitude of station", "Average Sulfur Dioxide(ppm)", "Average NO2(ppm)", "Average O3(ppm)", "Average CO(ppm)", "Average PM10(µg/m^3)", "Average PM2.5(µg/m^3 )"))
...
measurement_item_info_explaination <- data.frame(Variables = c("Item code", "Item name", "Unit of measurement", "Good(blue)", "Normal(green)", "Bad(yellow)", "Very bad(Red)"), 
                                                 Explaination = c("Measurement Date", "Measured item name", "Unit of measurement", "Good value", "Normal value", "Bad value", "Very bad value"))
